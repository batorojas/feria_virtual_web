<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fallo.aspx.cs" Inherits="feria_virtual_web.fallo" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title></title>
        ...
        function mostrarMensajeYRedirigir() {
            ...
            alert("Error al procesar su compra");
...
<body>
    <form id="form1" runat="server">
        <div>
             <h1> OCURRIO UN ERROR AL MOMENTO DE VALIDAR SU COMPRA ....  </h1>
